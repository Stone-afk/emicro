...
// Lz4Compressor Compressor lz4 zip Lz4 is a compression algorithm that allows "everyone to love and flowers to bloom".
...
func (c Lz4Compressor) Code() byte {
	return 2
}
...
// Uncompress data
func (c Lz4Compressor) Uncompress(data []byte) ([]byte, error) {
